...
void Graphics::RenderFrame()
{
	...
	if (ImGui::Button("Click me"))
		counter += 1;
	ImGui::SameLine();
	std::string clickCount = "Click Cound" + std::to_string(counter);
...
bool Graphics::InitializeScene()
{
	...
	//Load Texture
	hr = DirectX::CreateWICTextureFromFile(this->device.Get(), L"Data/Textures/cityPop.png", nullptr, myTexture.GetAddressOf());
	if (FAILED(hr))
	{
	...
	camera.SetProjectionValues(90.0f, static_cast<float>(windowHeight) / static_cast<float>(windowHeight), 0.1f, 1000.0f);
